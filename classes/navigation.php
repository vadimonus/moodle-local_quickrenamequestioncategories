...
class navigation extends navigation_node_base {
    ...
    public function get_navigation_title(): string {
        return get_string('quickrenamecategories', 'qbank_quickrenamecategories');
    }
    ...
    public function get_navigation_url(): \moodle_url {
        return new \moodle_url('/question/bank/quickrenamecategories/category.php');
    }
